...
namespace KonsolaKosc
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("Podaj liczbę oczek dla pierwszej kości (1-6):");
        ...
        static void WyswietlDane(Kosc k)
        {
            Console.WriteLine("Liczba instancji: " + Kosc.LiczbaInstancji);
            Console.WriteLine("Oczka: " + k.LiczbaOczek + " (" + k.ZwrocWartoscTekst() + ")");
            Console.WriteLine("Plik: " + "kosc" + k.IndeksObrazu + ".png");
            Console.WriteLine("-------------------------");
        }
    }
}